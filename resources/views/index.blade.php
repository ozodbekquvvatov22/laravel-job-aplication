                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 text-center mx-auto mb-4">
                            ...
                            <p><strong>Over 10k opening jobs</strong> Feel free to download and use our free templates from Tooplate website.</p>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    <h4 class="job-title">
                                        <a href="{{route ('about')}}" class="job-title-link">Graphic Designer</a>
                                    </h4>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-10">
                            ...
                            <p class="text-white">If you are looking for free templates, you may visit Tooplate website. If you need a collection of free templates, you can visit Too CSS website.</p>
                        </div>
